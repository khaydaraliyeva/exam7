...
urlpatterns = [
    ...
    path('admin-user_profiles/', views.user_profile_list, name='admin-user_profile_list'),
    ...
    path('admin-categories/', views.category_list, name='admin-category_list'),
    ...
    path('admin-brands/', views.brand_list, name='admin-brand_list'),
    path('admin-brands/create/', views.create_brand, name='admin-create_brand'),
    path('admin-brands/<int:pk>/', views.brand_detail, name='admin-brand_detail'),
    path('admin-brands/<int:pk>/edit/', views.update_brand, name='admin-update_brand'),
    path('admin-brands/<int:pk>/delete/', views.delete_brand, name='admin-delete_brand'),
